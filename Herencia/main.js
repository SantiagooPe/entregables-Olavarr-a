...
const auto1 = new Auto_1.Auto("AAA111", "Ford", "Focus", 3);
const moto1 = new Moto_1.Moto("BBB222", "Honda", "CBR", 600);
const camion1 = new Camion_1.Camion("CCC333", "Mercedes", "Actros", 25);
...
// Modificar una moto
registro.modificarMoto("BBB222", "Yamaha", "R6");
